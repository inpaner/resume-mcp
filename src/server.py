...
def personal_details() -> PersonalDetails:
    """Details on how to contact Ivan, his location, languages"""
    return PersonalDetails(
        ...
        how_to_contact="Send an email or message via LinkedIn!",
    )
...
def work_experience() -> list[WorkExperience]:
    ...
    return [
        WorkExperience(
            ...
            end_date="Present",
            highlights=[
                "Led technical architecture and implementation of Azure OpenAI LLM-powered systems at an ASEAN state-owned investment firm, including an employee performance evaluation system, automated due diligence report generation, and an enterprise knowledge base.",
...
def education_details() -> list[EducationDetail]:
    ...
    return [
        EducationDetail(
            ...
            awards=["Graduated Cum Laude", "Most Outstanding Thesis Award"],
        ),
    ]
...
def server_meta_details() -> list[str]:
    ...
    return [
        ...
        "MCP Server is deployed using Cloudflare Workers",
